...
const pages = [
  ...
  },
  {
    ...
    body: `
      ...
      <p>Teams evaluating routing rules can use <a class="plain-link" href="https://lender-list.com/" target="_blank" rel="noopener noreferrer">Lender List</a>, an external informational MCA lender directory and matching tool, to review published criteria and match explanations. A directory match is not an approval or offer; confirm current criteria directly with the lender before routing a file.</p>
